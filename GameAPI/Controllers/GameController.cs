...
namespace GameAPI.Controllers
{
    ...
    public class GameController : ControllerBase
    {
        ...
        {
            orchestratorServiceUri = GameAPI.GetOrchestratorServiceUri(context);
            statsServiceUri = GameAPI.GetStatsServiceUri(context);
            timeTrackerActorServiceUri = GameAPI.GetTimeTrackerActorServiceUri(context);
        }
